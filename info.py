...
USERNAME = environ.get('USERNAME', "https://t.me/Indar_off") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Requestyourmovie243')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002636919948').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
